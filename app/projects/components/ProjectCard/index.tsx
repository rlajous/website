...
const ProjectCard: React.FC<Project> = ({
  ...
  return (
    <div className="w-full bg-card text-card-foreground p-4 md:p-6 rounded-lg shadow-lg flex flex-col md:flex-row relative group hover:shadow-xl hover:-translate-y-0.5 transition-[transform,box-shadow,border-color] duration-200 border-l-2 border-l-transparent hover:border-l-primary">
      <Link
        href={`/projects/${slug}`}
        className="absolute inset-0 z-10"
        aria-label={`View project ${name}`}
      ...
      <div className="mb-3 md:mb-0 md:pr-4 md:border-r md:shrink-0">
        <div className="relative w-full md:w-[22rem] aspect-[2/1] rounded-md md:rounded-none overflow-hidden">
          <Image
            fill
            alt={name}
